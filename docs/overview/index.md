...
4. **Queue and worker layer**
   Import queues, enhancement queues, and authoritative sync jobs that let the system refresh incrementally.
5. **Interface layer**
...
### 3. Live Graph Control Should Be Remote-MCP-First
...
### 4. The Knowledge Graph Is Not Just Search Indexing
