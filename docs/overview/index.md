...
- [`src/core/discovery`](https://github.com/Iranb/PaperNexus/blob/main/src/core/discovery/workflow.js): provider-backed literature discovery, candidate merge, source resolution, discovery artifacts, and import bridge support
...
- [`src/core/materials`](https://github.com/Iranb/PaperNexus/blob/main/src/core/materials/agent-materials.js): Agent-facing material packs, project overlays, evidence carts, source-discovery plans, and research-controller artifacts
