...
function buildAnalyzeOptions(flags, config, commandName = 'analyze') {
  ...
  return {
    ...
    firecrawlApiBaseUrl: firstDefined(flags['firecrawl-api-base-url'], commandConfig.firecrawlApiBaseUrl),
    firecrawlApiKeyEnv: firstDefined(flags['firecrawl-api-key-env'], commandConfig.firecrawlApiKeyEnv),
    firecrawlMode: firstDefined(flags['firecrawl-mode'], commandConfig.firecrawlMode, 'auto'),
    firecrawlSourceMode: firstDefined(flags['firecrawl-source-mode'], commandConfig.firecrawlSourceMode, 'auto'),
    firecrawlMaxPages: toNumber(firstDefined(flags['firecrawl-max-pages'], commandConfig.firecrawlMaxPages), undefined),
