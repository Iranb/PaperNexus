...
function resolveNodeTypePriority(type) {
  const priorities = {
    ...
    [NODE_TYPES.RESEARCH_QUESTION]: 1,
    [NODE_TYPES.CHALLENGE]: 2,
    [NODE_TYPES.TAKEAWAY]: 3,
    [NODE_TYPES.IDEA_FRAGMENT]: 4,
    [NODE_TYPES.METHOD]: 5,
    [NODE_TYPES.LIMITATION]: 6,
    [NODE_TYPES.ASSUMPTION]: 7,
    [NODE_TYPES.PAPER]: 8,
    [NODE_TYPES.FUTURE_DIRECTION]: 9,
    [NODE_TYPES.CLAIM]: 10,
    [NODE_TYPES.FINDING]: 11,
    [NODE_TYPES.EVIDENCE_SNIPPET]: 12,
    [NODE_TYPES.EVIDENCE]: 13,
    [NODE_TYPES.DATASET]: 14,
    [NODE_TYPES.BENCHMARK]: 15,
    [NODE_TYPES.METRIC]: 16,
    [NODE_TYPES.CORPUS]: 17
  };
...
function scoreNode(node, queryTokens, queryText) {
  ...
  const typeBonuses = {
    ...
    [NODE_TYPES.RESEARCH_QUESTION]: 0.93,
    [NODE_TYPES.CHALLENGE]: 0.97,
    [NODE_TYPES.TAKEAWAY]: 0.89,
    [NODE_TYPES.IDEA_FRAGMENT]: 0.86,
    [NODE_TYPES.METHOD]: 0.85,
    [NODE_TYPES.FINDING]: 0.84,
    [NODE_TYPES.LIMITATION]: 0.92,
    [NODE_TYPES.ASSUMPTION]: 0.78,
    [NODE_TYPES.CLAIM]: 0.82,
    [NODE_TYPES.EVIDENCE_SNIPPET]: 0.63,
